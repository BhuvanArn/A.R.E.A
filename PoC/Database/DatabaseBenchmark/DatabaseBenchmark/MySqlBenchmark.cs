...
{
    public class MySqlBenchmark : IDatabaseBenchmark
    {
        private readonly string _connectionString = "Server=localhost;Port=3306;User ID=root;Password=password;Database=benchmarkdb";
        ...
        public void Setup()
        {
            try
            {
                var createDbConnectionString = "Server=localhost;Port=3306;User ID=root;Password=password;";
                ...
                Console.WriteLine("MySqlBenchmark Setup: 'benchmarkdb' and 'benchmark_table' are ready.");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"MySqlBenchmark Setup Error: {ex.Message}");
                throw;
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Console.WriteLine("MySqlBenchmark Cleanup: 'benchmark_table' has been dropped.");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"MySqlBenchmark Cleanup Error: {ex.Message}");
                throw;
            }
        }
        ...
        public void InsertSingle()
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark InsertSingle Error: {ex.Message}");
            }
        }
        ...
        public void InsertBulk(int count)
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark InsertBulk Error: {ex.Message}");
            }
        }
        ...
        public void ReadSingle()
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark ReadSingle Error: {ex.Message}");
            }
        }
        ...
        public void ReadBulk(int count)
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark ReadBulk Error: {ex.Message}");
            }
        }
        ...
        public void UpdateSingle()
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark UpdateSingle Error: {ex.Message}");
            }
        }
        ...
        public void UpdateBulk(int count)
        {
            try
            {
                ...
                var stopwatch = Stopwatch.StartNew();
                using var transaction = conn.BeginTransaction();
                using var cmd = new MySqlCommand($"UPDATE {_tableName} SET data = @data WHERE id = @id;", conn, transaction);
                cmd.Parameters.AddWithValue("@data", newData);
            ...
            {
                Console.WriteLine($"MySqlBenchmark UpdateBulk Error: {ex.Message}");
            }
        }
        ...
        public void DeleteSingle()
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark DeleteSingle Error: {ex.Message}");
            }
        }
        ...
        public void DeleteBulk(int count)
        {
            ...
            {
                Console.WriteLine($"MySqlBenchmark DeleteBulk Error: {ex.Message}");
            }
        }
